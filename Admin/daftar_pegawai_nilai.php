				...
				<div class = "container-fluid">
					<h4 class = "page-title">Nilai Kinerja Perawat</h4>
					<div class="row">
						<div class="col-md-12">
							<div class="card card-tasks">
									<div class="card-header ">
										...
										<div class='row'>
											<div class='col-md-7'>
												<h4 class="card-title">Daftar Perawat</h4>
											</div>
											
											<div class='col-md-4' >
												<input class="form-control" type="text" name="cari" placeholder="Nama Perawat"></input>
											</div>
